...
class ListenHistory(Model):
    ...
    mood_tags = db.Column(db.Text)  # JSON string of mood tags (ground truth from GPT)
    positivity_score = db.Column(db.Float)  # Overall positivity score (inferred from GPT)
    mood_tags_local = db.Column(db.Text)  # Local mood tags (JSON string, generated by local model)
    positivity_score_local = db.Column(db.Float)  # Local positivity score (inferred from local model)
    positivity_score_local_wghted = db.Column(db.Float)  # Local weighted positivity score (weighted by repeats_this_week)
